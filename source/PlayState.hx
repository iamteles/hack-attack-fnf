...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'blazing':
				dialogue = CoolUtil.coolTextFile(Paths.txt('blazing/dial'));
			case 'cheerio':
				dialogue = CoolUtil.coolTextFile(Paths.txt('cheerio/dial'));
				dialogueEnd = CoolUtil.coolTextFile(Paths.txt('cheerio/dialend'));
		}
		...
		switch (SONG.player1) 
		{
			...
			{
				p1ColorBar.setRGB(255, 140, 73, 255);
			}
			case 'bf-pixel':
			{
			...
			case 'dad':
			{
				p1ColorBar.setRGB(71, 152, 219, 255);
			}
			case 'mom' | 'mom-car':
			{
		...
		switch (SONG.player2) 
		{
			...
			case 'dad':
			{
				p2ColorBar.setRGB(71, 152, 219, 255);
			}
			case 'mom' | 'mom-car':
			{
